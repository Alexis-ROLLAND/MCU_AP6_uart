...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lib_test_lib_uart_ll_pic24.o: lib_test_lib_uart_ll_pic24.c  .generated_files/flags/default/55f147162b54f120c889f803c48f222e26427f27 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lib_test_lib_uart_ll_pic24.o.d 
	@${RM} ${OBJECTDIR}/lib_test_lib_uart_ll_pic24.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  lib_test_lib_uart_ll_pic24.c  -o ${OBJECTDIR}/lib_test_lib_uart_ll_pic24.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/lib_test_lib_uart_ll_pic24.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	
${OBJECTDIR}/lib_uart_pic24_ll.o: lib_uart_pic24_ll.c  .generated_files/flags/default/3545c323674595cb0c04171f96d0bbfc5de93b38 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lib_uart_pic24_ll.o.d 
	@${RM} ${OBJECTDIR}/lib_uart_pic24_ll.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  lib_uart_pic24_ll.c  -o ${OBJECTDIR}/lib_uart_pic24_ll.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/lib_uart_pic24_ll.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	
${OBJECTDIR}/test_lib_uart_ll_pic24_main.o: test_lib_uart_ll_pic24_main.c  .generated_files/flags/default/a5baa961dfa631d7e8ca74879b361d9f3f90dd8a .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/test_lib_uart_ll_pic24_main.o.d 
	@${RM} ${OBJECTDIR}/test_lib_uart_ll_pic24_main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  test_lib_uart_ll_pic24_main.c  -o ${OBJECTDIR}/test_lib_uart_ll_pic24_main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/test_lib_uart_ll_pic24_main.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
